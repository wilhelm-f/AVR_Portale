...
##
Alle Prefabs und Skripte werden in der Datei ([(https://github.com/wilhelm-f/AVR_Portale/blob/main/Doc/Dokumentation.md)](https://github.com/wilhelm-f/AVR_Portale/blob/main/Doc/Dokumentation.md)) genauer beschrieben
