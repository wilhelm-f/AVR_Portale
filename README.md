...
### Portal-Pads
Der Nutzer startet bei einem Testaufbau, der aus zwei Pads auf dem Boden mit jeweils einem Button besteht. Diese Pads sind hierbei die Portale und sind miteinander verbunden. Wird ein Pad betreten, wechselt das Material der von Eingangs- und Ausgangs-Pad und das Portal gilt als aktiv, die Änderung des Material zeigt gleichzeitig an, wohin das Portal den Nutzer teleportieren wird. Die Teleportation kann durch Interaktion mit einem sich bei einem Pad befindenden Button eingeleitet werden. Die Interaktion mit dem Button erfolgt über die Trigger Taste.
