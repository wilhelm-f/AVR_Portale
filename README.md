...
##
Alle Prefabs und Skripte werden in der Datei [Dokumentation.md]((https://github.com/wilhelm-f/AVR_Portale/blob/main/Doc/Dokumentation.md))"Dokumentation.md" genauer beschrieben
